...
*The purpose of this ePortfolio is to highlight my skills, abilities, and experience as a Software Engineering student at Southern New Hampshire University (SNHU) and was developed for my final Capstone course. The contents included are 3 projects from the following categories: Software Design and Engineering, Algorithms and Data Structures, Databases. Also included is a professional self-assessment, a link to a code review for the 3 projects, link to the source code for each project artifact, and the targeted course outcomes for my Capstone course to complete my Computer Science B.S. program. For each artifact directory, there is source code for the original program along with an enhanced version that details improvements I made for my Capstone course*
...
- *My journey as a Computer Science student has been a 5-year process. I spent the first 3 1/2 years at Mt. San Antonio Community College in Walnut, California, and the last 1 1/2 year at Southern New Hampshire University (SNHU). Throughout my time at both schools, I've developed various projects in different programming languages which include C++, Java, HTML, CSS, JavaScript. These projects cover a range of software development skills and techniques which include, utilizing secure coding techniques with exception handling, input validation, buffer validation, and SQL Injection, reverse engineering undocumented legacy code to recreate a new secure and functional source code, developing full-stack applications with Angular and Bootstrap frameworks, unit testing with JUnit and Google Test frameworks, utilizing JSwing libraries to build GUI applications, graphics programming with OpenGL and it's various libraries, utilizing algorithms to interact with data and data structures, and database management with applications while using Relational (MySQL) and Non-relational (MongoDB) databases with CRUD operations. These projects also allowed me to experience working in the Software Development Lifecycle. Along with Testing, Deployment, and Maintenance phases, I was able to work in the Planning, Analysis, and Design phases as well. During these projects, I interviewed and conducted focus groups with stakeholders and users regarding the application's design, features, and constraints. I also collaborated with classmates during the Analysis and Design phases when building applications while working within an Agile Scrum project management structure. Along these experiences, I've also successfully met my target goal of the Capstone course enhancements with my project enhancements. Overall, I feel my time as a student has prepared me with knowledge, tools, and skills to successfully pursue a career in software engineering.* 
