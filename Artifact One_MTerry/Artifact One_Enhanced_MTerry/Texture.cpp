...
Texture::Texture(const char* image, GLenum texType, unsigned int unitSlot, GLenum format, GLenum pixelType)
{
...
void Texture::texUnit(Shader& shader, const char* uniform, unsigned int unit) {
	...
	glUniform1i(glGetUniformLocation(shader.shaderID, uniform), unit);
}
